        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
          ...
          <div class="mb-4 border-b border-slate-200">
            <ul class="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
              ...
              <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                <router-link class="text-slate-500 hover:text-slate-600 whitespace-nowrap" to="#0">Web Sprint</router-link>
              </li>
              <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                <router-link class="text-slate-500 hover:text-slate-600 whitespace-nowrap" to="#0">Marketing</router-link>
              </li>
              <li class="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                <router-link class="text-slate-500 hover:text-slate-600 whitespace-nowrap" to="#0">Development</router-link>
              </li>
            </ul>
          </div>          
